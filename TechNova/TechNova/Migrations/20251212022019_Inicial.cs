    ...
    public partial class Inicial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Clientes__71ABD0A75CE34891", x => x.ClienteID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Producto__A430AE8313D288B8", x => x.ProductoID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Ventas__5B41514CA908CA76", x => x.VentaID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Detalle___6E19D6FAC8A2A038", x => x.DetalleID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__Clientes__A9D10534269A761E",
                table: "Clientes",
                column: "Email",
                unique: true);
